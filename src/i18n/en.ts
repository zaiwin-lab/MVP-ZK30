...
export const en: Dict = {
  ...
  participant: {
    account: {
      createTitle: 'Create Participant Account',
      createSupport: 'Sign up to track your application status and progress.',
      fullName: 'Full name',
      createAccount: 'Create Account',
      creatingAccount: 'Creating account…',
      passwordHint: 'At least 6 characters',
      signupError: 'Could not create the account. Try a different email or log in.',
      toggleToCreate: "Don't have an account? Create one",
      toggleToLogin: 'Already have an account? Log in',
      confirmTitle: 'Confirm Your Email',
      confirmBody: 'We sent a confirmation link to your email. Click it, then log in.',
      linkTitle: 'Link Your Semakan',
      linkBody: 'Enter the reference number and WhatsApp number you used during the Semakan to see your status.',
      linkRef: 'Reference number',
      linkPhone: 'WhatsApp number',
      linkBtn: 'Link Semakan',
      linking: 'Linking…',
      linkFail: 'Could not link. Check your reference and WhatsApp number.',
    },
