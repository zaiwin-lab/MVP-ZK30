...
export const ms = {
  ...
  semak2: {
    ...
    subtitle:
      'Ketahui sama ada pengalaman kerja, perniagaan atau kepimpinan anda mempunyai potensi untuk laluan Diploma—tanpa perlu berhenti kerja.',
    hook: 'Pengalaman anda dinilai. Anda tidak bermula dari kosong.',
    qPathway: 'Laluan diminati',
    pathwayOptions: {
      keusahawanan: 'Keusahawanan',
      kepimpinan: 'Kepimpinan & Pentadbiran Organisasi',
      unsure: 'Belum pasti',
    },
    pathwayUnsure: 'yang bersesuaian',
    qYears: 'Tahun pengalaman',
    yearsOptions: ['Kurang 2 tahun', '2–5 tahun', '5–10 tahun', 'Lebih 10 tahun'],
    qRole: 'Peranan sekarang',
    roleOptions: [
      'Usahawan / Pemilik',
      'Pengurus',
      'Penyelia / Ketua Pasukan',
      'Pemimpin NGO / Koperasi / Organisasi',
      'Staf Berpengalaman',
      'Lain-lain',
    ],
    qExperience: 'Pengalaman yang pernah dilakukan',
    experienceHint: 'Boleh pilih lebih daripada satu',
    experienceOptions: [
      'Mengurus pekerja',
      'Mengurus jualan atau pelanggan',
      'Mengurus kewangan',
      'Mengurus operasi',
      'Mengurus projek atau program',
      'Melatih atau membimbing orang lain',
      'Pentadbiran organisasi',
    ],
    seeResult: 'Lihat Potensi Saya',
    resultGood: 'Profil Anda Menunjukkan Potensi Yang Baik',
    resultReview: 'Pengalaman Anda Wajar Disemak Oleh Advisor',
    resultBody:
      'Pengalaman anda dalam {focus} menunjukkan asas yang relevan untuk dipertimbangkan bagi Laluan {pathway}. Pengalaman ini mempunyai nilai dan boleh dinilai serta disusun secara profesional.',
    disclaimer:
    ...
    errorTitle: 'Penghantaran tidak berjaya',
    errorBody:
  ...
  participant: {
    account: {
      createTitle: 'Buat Akaun Peserta',
      createSupport: 'Daftar untuk menjejak status permohonan dan kemajuan anda.',
      fullName: 'Nama penuh',
      createAccount: 'Buat Akaun',
      creatingAccount: 'Sedang membuat akaun…',
      passwordHint: 'Sekurang-kurangnya 6 aksara',
      signupError: 'Tidak dapat membuat akaun. Cuba e-mel lain atau log masuk.',
      toggleToCreate: 'Belum ada akaun? Buat akaun',
      toggleToLogin: 'Sudah ada akaun? Log masuk',
      confirmTitle: 'Sahkan E-mel Anda',
      confirmBody: 'Kami telah menghantar pautan pengesahan ke e-mel anda. Klik pautan itu, kemudian log masuk.',
      linkTitle: 'Pautkan Semakan Anda',
      linkBody: 'Masukkan nombor rujukan dan nombor WhatsApp yang anda guna semasa Semakan untuk melihat status anda.',
      linkRef: 'Nombor rujukan',
      linkPhone: 'Nombor WhatsApp',
      linkBtn: 'Pautkan Semakan',
      linking: 'Memautkan…',
      linkFail: 'Tidak dapat memautkan. Semak semula rujukan dan nombor WhatsApp anda.',
    },
