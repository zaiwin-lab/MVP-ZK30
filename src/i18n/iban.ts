...
export const iban: Dict = {
  ...
  semak2: {
    ...
    subtitle:
      'Nemu enti pengalaman kerja, bisnes tauka kepimpinan nuan bisi potensi ngagai jalai Diploma—enda ibuh ninggalka kerja.',
    hook: 'Pengalaman nuan bisi guna. Nuan ukai berengkah ari puang.',
    qPathway: 'Jalai ti dikedeka',
    pathwayOptions: {
      keusahawanan: 'Keusahawanan',
      kepimpinan: 'Kepimpinan & Pentadbiran Organisasi',
      unsure: 'Apin tetu',
    },
    pathwayUnsure: 'ti kena',
    qYears: 'Taun pengalaman',
    yearsOptions: ['Kurang ari 2 taun', '2–5 taun', '5–10 taun', 'Lebih 10 taun'],
    qRole: 'Peranan diatu',
    roleOptions: [
      'Usahawan / Tuan Empu',
      'Pengurus',
      'Penyelia / Tuai Pasukan',
      'Tuai NGO / Koperasi / Organisasi',
      'Staf Bepengalaman',
      'Bukai',
    ],
    qExperience: 'Pengalaman ti udah dikereja',
    experienceHint: 'Ulih milih lebih ari siti',
    experienceOptions: [
      'Ngurus pekerja',
      'Ngurus jualan tauka pelanggan',
      'Ngurus duit',
      'Ngurus operasi',
      'Ngurus projek tauka program',
      'Nlatih tauka mimbing orang bukai',
      'Pentadbiran organisasi',
    ],
    seeResult: 'Peda Potensi Aku',
    resultGood: 'Profil Nuan Mandangka Potensi Ti Manah',
    resultReview: 'Pengalaman Nuan Patut Disemak Advisor',
    resultBody:
      'Pengalaman nuan dalam {focus} mandangka dasar ti kena diperatika ngagai Jalai {pathway}. Pengalaman tu bisi guna lalu ulih dinilai sereta disusun secara profesional.',
    disclaimer:
    ...
    submitting: 'Ngirumka…',
    editAnswers: 'Ubah jawapan',
    errorTitle: 'Kiriman enda menyadi',
    errorBody:
  ...
  participant: {
    account: {
      createTitle: 'Guna Akaun Peserta',
      createSupport: 'Daftar kena nyilup status permohonan enggau kemajuan nuan.',
      fullName: 'Nama penuh',
      createAccount: 'Guna Akaun',
      creatingAccount: 'Benung ngaga akaun…',
      passwordHint: 'Sekurang-kurang 6 aksara',
      signupError: 'Enda ulih ngaga akaun. Cuba e-mel bukai tauka log masuk.',
      toggleToCreate: 'Apin bisi akaun? Guna akaun',
      toggleToLogin: 'Udah bisi akaun? Log masuk',
      confirmTitle: 'Pemendar E-mel Nuan',
      confirmBody: 'Kami udah ngirum pautan pemendar ngagai e-mel nuan. Klik pautan nya, udah nya log masuk.',
      linkTitle: 'Pautka Semakan Nuan',
      linkBody: 'Tulis nombor rujukan enggau nombor WhatsApp ti dikena nuan lebuh Semakan kena meda status nuan.',
      linkRef: 'Nombor rujukan',
      linkPhone: 'Nombor WhatsApp',
      linkBtn: 'Pautka Semakan',
      linking: 'Benung mautka…',
      linkFail: 'Enda ulih mautka. Perati baru rujukan enggau nombor WhatsApp nuan.',
    },
